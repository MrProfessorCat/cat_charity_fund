...
Revision ID: 7689645453c1
Revises: 
Create Date: 2023-08-23 00:04:18.267008
...
def upgrade():
    ...
    sa.CheckConstraint('0 <= invested_amount AND invested_amount <= full_amount'),
